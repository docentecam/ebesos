...
<div class="row" ng-show="showShop">
	...
	<form id="i-shop" class="row" name="i-shop" ng-submit="uploadFile()">
		...
		<div class="col-md-12">
			...
			<label for="lg-shop" class="btn-add col-lg-4">Examinar<i class="fa fa-plus-circle" aria-hidden="true"></i></label><input type="file" class="col-lg-4" id="lg-shop" name="lg-shop" uploader-model="shopOne.logo" ng-show="false">
			<input type="text" class="col-lg-4 col-lg-offset-2" id="url-shop" name="url-shop" placeholder="www.webtenda.com" name="" ng-model="shopOne.web">
		</div>
		<div class="col-md-12">
