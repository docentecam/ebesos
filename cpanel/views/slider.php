		...
		<div id="whiteSliderDiv" class="col-lg-12">
			...
			<div ng-show="sliderAdding">
					...
					<div class="row">
						...
						<textarea class=" col-lg-4 editAndAddSlider" name="" id="" cols="30" rows="6" placeholder="Escriu aquí el subtítol de la imatge a mostrar dins del Slider..."></textarea>
					</div>
					<div class="row">
						<label class="col-lg-2 col-lg-offset-3">Enllaç: </label>
						<input type="text" class="col-lg-4 editAndAddSlider" name="" id="link" size="40" placeholder="Escriu aquí l'enllaç de la imatge a relacionar" >
					</div>
					<div class="row">
			...
			<div ng-show="sliderEditing" ng-repeat="infoSlider in onlyInfoSlider">
				<form id="editingForm">
					...
					<div class="row">
						<label class="col-lg-2 col-lg-offset-3">Enllaç: </label>
						<input type="text" class=" col-lg-4 editAndAddSlider" name="" id="linkSlider" size="40"  ng-value="infoSlider.link">
					</div>
					<div class="row">
						<input class="col-lg-offset-5 editAndAddSlider" type="button" value="Actualitzar" ng-click=backSettingSlide()>
					</div>
